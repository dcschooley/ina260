...
class INA260(object):
	...
	def readAnalog(self, param, scale):
		if self._myBus:
	...
	def writeDigital(self, param, dig):
		if self._myBus:
			dig = bswap(dig)
			self._myBus.write_word_data(self._myAddr, param, dig)

	def readVoltage(self):
		voltage = self.readAnalog(INA260_REG_BUSVOLTAGE, voltageScale)
		return(voltage)

	def readCurrent(self):
		current = self.readAnalog(INA260_REG_CURRENT, currentScale)
		return(current)
		
	def readPower(self):
		power = self.readAnalog(INA260_REG_POWER, powerScale)
		return(power)

	def readMode(self):
		mode = self.readDigital(INA260_REG_CONFIG) & 0x7
		return(mode)	
		
	def readAvgMode(self):
		mode = self.readDigital(INA260_REG_CONFIG)
		mode = (mode >> 9) & 0x7
		return(mode)
	...
	def readConfig(self):
		reg = self.readDigital(INA260_REG_CONFIG)
		return(reg)
		
	def resetConfig(self):
		self.writeDigital(INA260_REG_CONFIG, 0x8000)
	...
	def setModeShutdown(self):
		self.setOpMode(INA260_MODE_SHUTDOWN)
		
	def setModeTriggered(self):
		self.setOpMode(INA260_MODE_TRIGGERED)

	def setModeContinuous(self):
		self.setOpMode(INA260_MODE_CONTINUOUS)
...
# Functions to set the averaging mode in terms of the number of samples
	...
	def setAvgMode_1(self):
		self.setAvgMode(INA260_COUNT_1)

	def setAvgMode_4(self):
		self.setAvgMode(INA260_COUNT_4)

	def setAvgMode_16(self):
		self.setAvgMode(INA260_COUNT_16)

	def setAvgMode_64(self):
		self.setAvgMode(INA260_COUNT_64)

	def setAvgMode_128(self):
		self.setAvgMode(INA260_COUNT_128)

	def setAvgMode_256(self):
		self.setAvgMode(INA260_COUNT_256)

	def setAvgMode_512(self):
		self.setAvgMode(INA260_COUNT_512)

	def setAvgMode_1024(self):
		self.setAvgMode(INA260_COUNT_1024)
		
		
# Functions to set the conversion times. 

	def setCurrCnvTime(self, time):
		if self._myBus:
			reg = self._myBus.read_word_data(self._myAddr, INA260_REG_CONFIG)
			reg = bswap(reg)
	...
	def setCurrCnvTime_140usec(self):
		self.setCurrCnvTime(INA260_TIME_140_us)

	def setVoltCnvTime_140usec(self):
		self.setVoltCnvTime(INA260_TIME_140_us)
	...
	def setCurrCnvTime_204usec(self):
		self.setCurrCnvTime(INA260_TIME_204_us)

	def setVoltCnvTime_204usec(self):
		self.setVoltCnvTime(INA260_TIME_204_us)
	...
	def setCurrCnvTime_332usec(self):
		self.setCurrCnvTime(INA260_TIME_332_us)

	def setVoltCnvTime_332usec(self):
		self.setVoltCnvTime(INA260_TIME_332_us)
	...
	def setCurrCnvTime_588usec(self):
		self.setCurrCnvTime(INA260_TIME_558_us)

	def setVoltCnvTime_588usec(self):
		self.setVoltCnvTime(INA260_TIME_588_us)
	...
	def setCurrCnvTime_1_1ms(self):
		self.setCurrCnvTime(INA260_TIME_1_1_ms)

	def setVoltCnvTime_1_1ms(self):
		self.setVoltCnvTime(INA260_TIME_1_1_ms)
	...
	def setCurrCnvTime_2_116ms(self):
		self.setCurrCnvTime(INA260_TIME_2_116_ms)

	def setVoltCnvTime_2_116ms(self):
		self.setVoltCnvTime(INA260_TIME_2_116_ms)
	...
	def setCurrCnvTime_4_156ms(self):
		self.setCurrCnvTime(INA260_TIME_4_156_ms)

	def setVoltCnvTime_4_156ms(self):
		self.setVoltCnvTime(INA260_TIME_4_156_ms)
	...
	def setCurrCnvTime_8_244ms(self):
		self.setCurrCnvTime(INA260_TIME_8_244_ms)

	def setVoltCnvTime_8_244ms(self):
		self.setVoltCnvTime(INA260_TIME_8_244_ms)
	...
	def setOverCurrentLimit(self, limit):
		if self._myBus:
			self.writeAnalog(INA260_REG_ALERT_LIMIT, limit, currentScale)
			mask = self.readDigital(INA260_REG_MASK_ENABLE)
			mask = (mask & 0x0403) + 0x8000
			self.writeDigital(INA260_REG_MASK_ENABLE, mask)
	...
	def setOverVoltageLimit(self, limit):
		if self._myBus:
			self.writeAnalog(INA260_REG_ALERT_LIMIT, limit, voltageScale)
			mask = self.readDigital(INA260_REG_MASK_ENABLE)
	...
	def setOverPowerLimit(self, limit):
		if self._myBus:
			self.writeAnalog(INA260_REG_ALERT_LIMIT, limit, powerScale)
			mask = self.readDigital(INA260_REG_MASK_ENABLE)
			mask = (mask & 0x0403) + 0x800
			self.writeDigital(INA260_REG_MASK_ENABLE, mask)
			
	def setAlertLatch(self):
		dig = self.readDigital(INA260_REG_MASK_ENABLE)
		if dig:
			dig = (dig & 0xFFFE) + 1
			self.writeDigital(INA260_REG_MASK_ENABLE, dig)
	...
	def readLimitRegister(self):
		dig = self.readDigital(INA260_REG_ALERT_LIMIT)
		return (dig)

	def readManufID(self):
		manufID = self.readDigital(INA260_REG_MFG_UID)
		return manufID
